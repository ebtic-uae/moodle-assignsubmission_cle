...
echo $OUTPUT->box_end();
echo $OUTPUT->box_start();
echo '<iframe src="' . $url . '/p/' . $pad . '?showControls=true&showChat=false&showLineNumbers=false&useMonospaceFont=false&userName=' . $USER->firstname . '" width="100%" height="400">Your browser does not diplay iFrames</iframe>';
echo $OUTPUT->box_end();
