...
class assign_submission_cle extends assign_submission_plugin {
    ...
    public function get_form_elements($submission, MoodleQuickForm $mform, stdClass $data) {
        ...
        if ($edit) {
            ...
            $mform->addElement('cleeditor', 'cleeditor', '', array('pad_code' => $pad_code, 'firstname' => $USER->firstname, 'url' => $url, 'cm' => $cm->id, 'id' => $this->assignment->get_instance()->id), $editoroptions);
        }
        return true;
    }
    ...
    public function save(stdClass $submission, stdClass $data) {
        ...
        $data->onlinetext .= $etherpad->getHTML($pad_code)->html;
